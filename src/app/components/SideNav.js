...
export default function SideNav() {
  ...
  return (
    <div
      className={` left-0 top-19 fixed font-gothic text-lg  flex text-gray-300 h-full w-70 z-50  bg-[#000000]`}
    >
      ...
      <div className="relative h-screen w-12 border-r-2 border-gray-500">
        <div
          ...
          className="absolute top-10 -right-6 w-12 h-12 bg-[#0D0D0D] border-2 border-gray-500 rounded-full flex items-center justify-center hover:cursor-pointer"
        >
